 ...
 */
package com.reply.tyreshop.addons.callback.jalo;
...
import com.reply.tyreshop.addons.callback.constants.CallbackaddonConstants;



/**
 * This is the extension manager of the Callbackaddon extension.
 */
public class CallbackaddonManager extends GeneratedCallbackaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CallbackaddonManager.class.getName());
	 ...
	 */
	public static CallbackaddonManager getInstance()
	{
		return (CallbackaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				CallbackaddonConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CallbackaddonManager() 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CallbackaddonManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CallbackaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CallbackaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
