...
import com.reply.tyreshop.fulfilmentprocess.test.actions.TestActionTemp;
...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/tyreshopfulfilmentprocess/test/tyreshopfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/tyreshopfulfilmentprocess/test/tyreshopfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/tyreshopfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/tyreshopfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/tyreshopfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/tyreshopfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/tyreshopfulfilmentprocess/test/tyreshopfulfilmentprocess-spring-testcleanup.xml"));
