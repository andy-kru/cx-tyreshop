 ...
 */
package com.reply.tyreshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(TyreshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TyreshopFulfilmentProcessConstants.PARENT_PROCESS);
