...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/tyreshopfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/tyreshopfulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/tyreshopfulfilmentprocess/test/process/consignment-process.xml");
