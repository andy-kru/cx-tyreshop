 ...
 */
package com.reply.tyreshop.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, TyreshopFulfilmentProcessConstants.PARENT_PROCESS);
