 ...
 * --- Generated at Mar 22, 2019 3:00:25 PM                     ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 ...
 */
package com.reply.tyreshop.fulfilmentprocess.jalo;
...
/**
 * Generated class for type <code>TyreshopFulfilmentProcessManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedTyreshopFulfilmentProcessManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return TyreshopFulfilmentProcessConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, TyreshopFulfilmentProcessConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
