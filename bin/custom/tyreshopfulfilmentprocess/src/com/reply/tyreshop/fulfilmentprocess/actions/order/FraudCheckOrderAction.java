 ...
 */
package com.reply.tyreshop.fulfilmentprocess.actions.order;
...
public class FraudCheckOrderAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(TyreshopFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimitExternal"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(TyreshopFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreToleranceExternal"));
