...
public class FraudCheckOrderInternalAction extends AbstractFraudCheckAction<OrderProcessModel>
{
	...
	public Transition executeAction(final OrderProcessModel process)
	{
		...
		final double scoreLimit = Double.parseDouble(Config.getParameter(TyreshopFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreLimit"));
		final double scoreTolerance = Double.parseDouble(Config.getParameter(TyreshopFulfilmentProcessConstants.EXTENSIONNAME + ".fraud.scoreTolerance"));
