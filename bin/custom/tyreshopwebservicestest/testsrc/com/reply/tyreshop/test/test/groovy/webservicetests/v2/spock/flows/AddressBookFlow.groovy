 ...
 *
 */
package com.reply.tyreshop.test.test.groovy.webservicetests.v2.spock.flows
...
import com.reply.tyreshop.test.test.groovy.webservicetests.v2.spock.users.AbstractUserTest
...
class AddressBookFlow extends AbstractUserTest {
	...
	def "Address book flow : #format"() {
		...
		and: "remove second address, first one should be marked as default again"
