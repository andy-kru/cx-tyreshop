 ...
 */
package com.reply.tyreshop.test.test.groovy.webservicetests.addons
...
import com.reply.tyreshop.test.test.groovy.webservicetests.v1.BaseWSTest
...
class AccProductTests extends BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("tyreshopwebservicestest.enableAccTest", false)
				&& Config.getBoolean("tyreshopwebservicestest.enableV1", false))
	}
