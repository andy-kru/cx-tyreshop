...
import com.reply.tyreshop.test.test.groovy.webservicetests.SSLIssuesIgnoringHttpClientFactory
import com.reply.tyreshop.test.test.groovy.webservicetests.config.TestConfigFactory
...
abstract class AbstractSpockTest extends Specification {
	private static String LOG4J_PROPERTIES_CLASS_PATH="tyreshopwebservicestest/log4j.properties";
	...
	protected static ConfigObject config = TestConfigFactory.createConfig("v2","/tyreshopwebservicestest/groovytests-property-file.groovy");
