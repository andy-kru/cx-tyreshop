 ...
 */
package com.reply.tyreshop.test.test.groovy.webservicetests.config
...
public class ModuleConstants {
	...
	//original name of the web services module, it is not touched by modulegen because we are in tyreshopwebservicestest
	...
	public static final String CURRENT_TEST_EXTENSION_NAME = 'tyreshopwebservicestest';
