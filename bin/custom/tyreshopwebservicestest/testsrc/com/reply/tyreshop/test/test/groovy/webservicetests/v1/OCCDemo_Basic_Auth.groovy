...
class OCCDemo_Basic_Auth extends BaseWSTest {
	...
	void testSimpleFlow() {
		...
		postBody = "accountHolderName=Sven+Haiges&cardNumber=4111111111111111&cardType=visa&expiryMonth=01&expiryYear=2013&saved=true&defaultPaymentInfo=true&billingAddress.titleCode=mr&billingAddress.firstName=sven&billingAddress.lastName=haiges&billingAddress.line1=test1&billingAddress.line2=test2&billingAddress.postcode=12345&billingAddress.town=somecity&billingAddress.country.isocode=US&billingAddress.region.isocode=US-NY"
