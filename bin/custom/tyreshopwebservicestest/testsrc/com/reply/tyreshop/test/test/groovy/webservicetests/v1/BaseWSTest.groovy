...
import com.reply.tyreshop.test.test.groovy.webservicetests.TestNamePrinter
...
import com.reply.tyreshop.test.test.groovy.webservicetests.docu.BaseWSTestWatcher
...
class BaseWSTest {
	...
	public void ignoreIf(){
		org.junit.Assume.assumeTrue(Config.getBoolean("tyreshopwebservicestest.enableV1", false))
	}
	...
	protected BaseWSTest() {
		config = TestConfigFactory.createConfig("v1", "/tyreshopwebservicestest/groovytests-property-file.groovy");
