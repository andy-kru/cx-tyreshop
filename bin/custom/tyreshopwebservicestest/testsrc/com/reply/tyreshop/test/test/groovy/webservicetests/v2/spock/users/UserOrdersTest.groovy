 ...
 *
 */
package com.reply.tyreshop.test.test.groovy.webservicetests.v2.spock.users
...
class UserOrdersTest extends AbstractUserTest {
	...
	def "Customer gets number of his orders with status : #format"() {
	...
	def "Customer gets number of his orders with wrong status: #format"() {
