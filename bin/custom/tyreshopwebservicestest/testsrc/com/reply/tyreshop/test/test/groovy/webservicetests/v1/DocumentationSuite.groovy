...
import com.reply.tyreshop.test.test.groovy.webservicetests.DocumentationSuiteGuard
import com.reply.tyreshop.test.test.groovy.webservicetests.TestUtil
import com.reply.tyreshop.test.test.groovy.webservicetests.docu.SaveWSOutputStrategy
import com.reply.tyreshop.test.test.groovy.webservicetests.docu.TestUtilCustomDelegatingMetaClass
import com.reply.tyreshop.test.test.groovy.webservicetests.markers.AvoidCollectingOutputFromTest
...
/**
 * Suite contains all tests from {@link com.reply.tyreshop.test.test.groovy.webservicetests.v1.AllTests} suite, including test from {@link CollectOutputFromTest} category
