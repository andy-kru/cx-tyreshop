...
public class TestSetupUtils
{
	...
	private static void setupCommerce(final BiConsumer<TyreshopwebservicesTestSetup, SystemSetupContext> triggerEqualsValidator)
	{
		final TyreshopwebservicesTestSetup setup = getCommerceWebServicesTestSetup();
	...
	private static TyreshopwebservicesTestSetup getCommerceWebServicesTestSetup()
	{
		return Registry.getApplicationContext().getBean("yCommerceWebServicesTestSetup", TyreshopwebservicesTestSetup.class);
	}
	...
	private static SystemSetupContext createSystemSetupContext()
	{
		...
		{ "Go" });
		params.put("tyreshopwebservicestest_sample", new String[]
		{ "true" });
		...
		return new SystemSetupContext(params, Type.ALL, Process.ALL, "tyreshopwebservicestest");
	}
	...
	{
		if (!Config.getBoolean("tyreshopwebservicestest.embedded.server.enabled", true))
		{
