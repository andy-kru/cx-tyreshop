...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/static/paypal-webapp.css"/>" type="text/css"
          media="screen, projection"/>
</head>
<div class="container">
    <img src="<c:url value="${logoUrl}" />" alt="Hybris platform logo"/>

    <h2>Welcome to "paypal" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/paypal-items.xml</b> - here you can model your items</li>
            <li><b>resources/paypal-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/paypal-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/paypal-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/paypal-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
