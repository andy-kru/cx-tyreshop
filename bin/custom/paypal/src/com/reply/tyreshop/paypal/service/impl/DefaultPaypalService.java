...
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultPaypalService.class);
	...
	{
		return DefaultPaypalService.class.getResourceAsStream("/paypal/sap-hybris-platform.png");
	}
