 ...
 */
package com.reply.tyreshop.core.constants;

/**
 * Global class for all TyreshopCore constants. You can add global constants for your extension into this class.
 */
public final class TyreshopCoreConstants extends GeneratedTyreshopCoreConstants
{
	public static final String EXTENSIONNAME = "tyreshopcore";


	private TyreshopCoreConstants()
	{
		//empty
	}
