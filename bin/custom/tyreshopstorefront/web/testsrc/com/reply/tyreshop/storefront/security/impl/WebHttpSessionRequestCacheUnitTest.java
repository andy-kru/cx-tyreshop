...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tyreshopstorefront/electronics/en",
						"https://electronics.local:9002/tyreshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/tyreshopstorefront/electronics/en",
						"https://electronics.local:9002/tyreshopstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tyreshopstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/tyreshopstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/tyreshopstorefront/electronics/en",
						"https://electronics.local:9002/tyreshopstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tyreshopstorefront",
						"https://electronics.local:9002/tyreshopstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/tyreshopstorefront",
						"https://electronics.local:9002/tyreshopstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/tyreshopstorefront/electronics/en",
						"https://electronics.local:9002/tyreshopstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
