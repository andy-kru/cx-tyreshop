 ...
 */
package com.reply.tyreshop.storefront.controllers.misc;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "tyreshopstorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("tyreshopstorefront.quick.order.rows.max", 25);
