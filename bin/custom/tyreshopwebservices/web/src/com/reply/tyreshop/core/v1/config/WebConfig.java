 ...
 */
package com.reply.tyreshop.core.v1.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import com.reply.tyreshop.core.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "tyreshopwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "tyreshopwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "tyreshopwebservices.oauth2.tokenUrl";

	private static final String DESC = "tyreshopwebservices.v1.description";
	private static final String TITLE = "tyreshopwebservices.v1.title";
	private static final String VERSION = "tyreshopwebservices.v1.version";
